...
namespace Second_Swap.Service
{
    public class VnPayService : IVnPayService
    {
        ...
        public VnPayService(IConfiguration config, SecondSwapContext db)
        {
            _config = config;
            _db = db;
        }
        ...
        public VnPaymentResponseModel PaymentExecute(IQueryCollection collections)
        {
            ...
            var sucess =  new VnPaymentResponseModel
            {
                Success = true,
                PaymentMethod = "VnPay",
            ...
            var order = _db.Orders.FirstOrDefault(x => x.Id == int.Parse(vnp_OrderInfo));
